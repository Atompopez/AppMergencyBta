    ...
    private fun createTipificationLessons(): List<Lesson> {
        return listOf(
            ...
            Lesson(
                ...
                content = "Los códigos de emergencia están organizados por categorías según el tipo de incidente. Cada código tiene un significado específico y puede tener modificadores que indican circunstancias especiales. Es fundamental memorizar estos códigos para una respuesta rápida y eficaz.\n\nLos códigos se dividen en las siguientes categorías principales:\n\n1. Seguridad (100-199): Incluye delitos contra personas y propiedad\n   - 101: Homicidio\n   - 102: Lesiones personales\n   - 103: Riña\n   - 120: Hurto a residencia\n   - 121: Hurto a establecimiento\n   - 122: Hurto a vehículo\n\n2. Convivencia (200-299): Situaciones que alteran la convivencia ciudadana\n   - 201: Escándalo\n   - 202: Consumo de sustancias en espacio público\n   - 203: Perturbación a la tranquilidad\n\n3. Movilidad (300-399): Incidentes relacionados con el tránsito\n   - 301: Accidente de tránsito con heridos\n   - 302: Accidente de tránsito solo daños\n   - 303: Vehículo mal estacionado\n\n4. Emergencias médicas (400-499): Situaciones que requieren atención médica\n   - 401: Paro cardiorrespiratorio\n   - 402: Dificultad respiratoria\n   - 403: Herida por arma\n\n5. Desastres (500-599): Incidentes que afectan infraestructura o grandes áreas\n   - 501: Incendio estructural\n   - 502: Incendio forestal\n   - 503: Inundación\n\nLa memorización y correcta aplicación de estos códigos es esencial para tu labor como operador de la línea 123.",
                order = 2
            ),
            Lesson(
                id = "tipification_modifiers",
                title = "Modificadores de Códigos",
                content = "Los modificadores son elementos adicionales que se agregan a los códigos básicos para indicar circunstancias específicas del incidente, como la presencia de armas, personas heridas, o situaciones de riesgo especial.\n\nLos principales modificadores utilizados en el sistema de emergencias de Bogotá son:\n\n- A: Arma de fuego. Indica la presencia o uso de armas de fuego en el incidente.\n  Ejemplo: 103-A (Riña con arma de fuego)\n\n- B: Arma blanca. Indica la presencia o uso de armas cortopunzantes.\n  Ejemplo: 103-B (Riña con arma blanca)\n\n- H: Herido. Indica que hay personas lesionadas en el incidente.\n  Ejemplo: 301-H (Accidente de tránsito con heridos)\n\n- M: Menor de edad. Indica la participación o afectación de menores de edad.\n  Ejemplo: 202-M (Consumo de sustancias por menores)\n\n- P: En progreso. Indica que el incidente está ocurriendo en el momento de la llamada.\n  Ejemplo: 120-P (Hurto a residencia en progreso)\n\n- V: Violencia intrafamiliar. Indica situaciones de violencia en el entorno familiar.\n  Ejemplo: 102-V (Lesiones personales en contexto de violencia intrafamiliar)\n\n- T: Persona atrapada. Indica que hay personas atrapadas en estructuras o vehículos.\n  Ejemplo: 301-T (Accidente de tránsito con personas atrapadas)\n\nLos modificadores pueden combinarse cuando múltiples circunstancias están presentes.\nEjemplo: 103-A-H (Riña con arma de fuego y heridos)\n\nEl uso correcto de los modificadores permite a las agencias de respuesta prepararse adecuadamente antes de llegar al lugar del incidente.",
                order = 3
            ),
            Lesson(
                id = "tipification_agencies",
                title = "Agencias de Respuesta",
                content = "Cada código de emergencia está asociado a una o más agencias de respuesta, como Policía, Bomberos, o Servicios Médicos. Es importante conocer qué agencia debe ser activada para cada tipo de incidente.\n\nLas principales agencias de respuesta en Bogotá son:\n\n1. Policía Nacional:\n   - Atiende incidentes de seguridad ciudadana (códigos 100-199)\n   - Situaciones de convivencia (códigos 200-299)\n   - Apoyo en emergencias de tránsito (códigos 300-399)\n\n2. Secretaría de Salud / CRUE:\n   - Emergencias médicas (códigos 400-499)\n   - Atención a heridos en cualquier tipo de incidente\n   - Traslados hospitalarios\n\n3. Bomberos:\n   - Incendios estructurales y forestales (códigos 501, 502)\n   - Rescates en altura, espacios confinados o estructuras colapsadas\n   - Incidentes con materiales peligrosos\n   - Rescate de personas atrapadas en accidentes de tránsito\n\n4. Movilidad:\n   - Regulación del tránsito en accidentes (códigos 300-399)\n   - Control de vías afectadas por emergencias\n\n5. Defensa Civil:\n   - Apoyo en desastres naturales (códigos 500-599)\n   - Búsqueda y rescate\n   - Evacuaciones\n\n6. IDIGER (Instituto Distrital de Gestión de Riesgos):\n   - Evaluación de riesgos estructurales\n   - Coordinación en emergencias de gran magnitud\n   - Gestión de albergues temporales\n\nEn muchos casos, se requiere la activación de múltiples agencias para atender un mismo incidente. Por ejemplo, un accidente de tránsito con heridos puede requerir la presencia de Policía, Secretaría de Salud y Movilidad simultáneamente.",
                order = 4
            ),
            Lesson(
